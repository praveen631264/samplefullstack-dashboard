-- =============================================================================
-- Test Orchestrator v2.0 - DDL Schema (PostgreSQL)
...
CREATE TABLE IF NOT EXISTS sample_events (
    ...
    principal_rate          NUMERIC(15, 4),
    premium_rate            NUMERIC(15, 4),
    security_called_amount  NUMERIC(20, 2),
...
CREATE TABLE IF NOT EXISTS workflow_executions (
    ...
    source1_file_data   BYTEA,
    source2_file_data   BYTEA,
...
CREATE TABLE IF NOT EXISTS agent_configs (
    ...
    maker_file_data     BYTEA,
    checker_file_name   VARCHAR(255),
    checker_file_data   BYTEA,
    created_at          TIMESTAMP DEFAULT (NOW() AT TIME ZONE 'America/New_York'),
    updated_at          TIMESTAMP DEFAULT (NOW() AT TIME ZONE 'America/New_York')
);
